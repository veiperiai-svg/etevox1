      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <motion.div
          ...
          <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-foreground mb-6">
            <span className="gradient-text font-black">Etevox</span> <span className="font-light text-foreground">|</span> <span className="font-['Caveat'] font-bold text-foreground italic">Media</span>
          </h1>
